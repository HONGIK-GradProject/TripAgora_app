  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <ScrollView contentContainerClassName="px-5 pb-24">
        ...
        <View className="mb-7">
          <Text className="text-2xl font-bold mb-2.5">김 홍익 가이드님의 여행 상품</Text>
        ...
        <View className="mb-7">
          ...
          <View className="bg-white border border-gray-400 rounded-3xl p-4 mb-4">
            <View className="flex-row items-center mb-2.5">
              <Image source={{ uri: 'https://via.placeholder.com/40' }} className="w-10 h-10 rounded-full mr-2.5 bg-gray-300" />
              <Text className="text-xl text-black">홍 길동, 후쿠오카 놀러가실분</Text>
            </View>
          ...
          <View className="bg-white border border-gray-400 rounded-3xl p-4 mb-4">
            <View className="flex-row items-center mb-2.5">
              <Image source={{ uri: 'https://via.placeholder.com/40' }} className="w-10 h-10 rounded-full mr-2.5 bg-gray-300" />
              <Text className="text-xl text-black">박 대기, 홍대 1박2일 모임</Text>
            </View>
