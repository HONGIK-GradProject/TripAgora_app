      ...
      <View className='flex-row border-b border-gray-400 mx-5 mb-5'>
        <TouchableOpacity
          className={`flex-1 items-center py-2.5 border-b ${
            activeTab === 'ongoing' ? 'border-primary' : 'border-transparent'
          }`}
      ...
      <ScrollView contentContainerClassName='px-5 pb-24'>
        <View>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/guide/session/recruitmentDetail?id=1')}
          >
            <Image
          ...
          <TouchableOpacity
            className='flex-row bg-white border border-gray-400 rounded-3xl p-4 mb-4 items-center'
            onPress={() => router.push('/guide/session/recruitmentDetail?id=2')}
          >
            <Image
              source={{ uri: 'https://via.placeholder.com/90' }}
              className='w-24 h-24 rounded-xl mr-4'
