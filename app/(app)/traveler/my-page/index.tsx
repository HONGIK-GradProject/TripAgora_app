  ...
  return (
    <View className="flex-1 bg-white">
      <View className="items-center px-5 pt-12 pb-5 border-b border-gray-200">
        ...
        <Text className="text-2xl text-gray-500 mb-2.5">여행 0건, 가이드 0건</Text>
        <TouchableOpacity className="bg-white/50 border border-black rounded-md py-2.5 px-5" onPress={handleSwitchUserRole}>
          <Text className="text-xl text-black">{'여행자 <-> 가이드 전환하기'}</Text>
        </TouchableOpacity>
      </View>
