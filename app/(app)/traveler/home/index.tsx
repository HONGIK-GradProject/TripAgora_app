    ...
    <View className="flex-1 bg-white">
      ...
      <ScrollView contentContainerClassName="px-5 pb-24">
        <View className="flex-row bg-gray-300 rounded-3xl p-5 mt-5 items-center">
          <Image source={{ uri: 'https://via.placeholder.com/80' }} className="w-20 h-20 rounded-full mr-4" />
          <View className="flex-1">
            <Text className="text-2xl font-bold mb-1">여행을 떠나보아요!</Text>
...
딱 맞는 여행을 찾아보세요!
        ...
        <View className="mt-7">
          <Text className="text-2xl font-bold mb-4">당신의 태그에 맞춘 여행 상품 추천</Text>
        ...
        <View className="mt-7">
          <Text className="text-2xl font-bold mb-4">이달의 가이드 TOP 3</Text>
          <View className="bg-white border border-gray-400 rounded-3xl p-4 mb-2.5">
            <Text className="text-2xl text-black">투어리즘(김영진) 평점 4.95</Text>
          </View>
          <View className="bg-white border border-gray-400 rounded-3xl p-4 mb-2.5">
            <Text className="text-2xl text-black">낫쏘리(안미안) 평점 4.93</Text>
          </View>
          <View className="bg-white border border-gray-400 rounded-3xl p-4 mb-2.5">
